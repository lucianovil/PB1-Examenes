...
public class Vuelo {
	...
	public Vuelo (String id, String ciudadOrigen, String ciudadDestino, double precio, int numMaxPasajeros) {
	...
	public Pasajero getPasajero (String pasaporte) {
		...
		while ((!encontrado) && (i<listaPasajeros.length)) {
			...
			//(pasaporte == listaPasajeros[i].getPasaporte()) { esto es lo mismo
				encontrado = true;
