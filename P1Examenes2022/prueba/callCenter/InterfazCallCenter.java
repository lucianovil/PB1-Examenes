...
public class InterfazCallCenter {
	...
	private static void darDeAltaNuevoContacto(Scanner teclado, Empresa actual) {
		...
		System.out.println("Ingrese el n�mero de provincia" );
